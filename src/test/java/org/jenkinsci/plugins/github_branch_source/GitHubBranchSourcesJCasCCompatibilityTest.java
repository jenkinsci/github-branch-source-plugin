...
public class GitHubBranchSourcesJCasCCompatibilityTest extends RoundTripAbstractTest {
  ...
  @Issue("JENKINS-57557")
  @Override
  protected void assertConfiguredAsExpected(
      RestartableJenkinsRule restartableJenkinsRule, String s) {
    ...
    assertThat(
        forkDiscovery.getTrust(), instanceOf(ForkPullRequestDiscoveryTrait.TrustPermission.class));
  }
