...
public class GitHubRepoSizeEstimatorTest extends GitSCMSourceBase {
  ...
  public void isApplicableToTest() throws Exception {
    GitHubRepoSizeEstimator.RepositorySizeGithubAPI api =
        j.jenkins
            .getExtensionList(GitToolChooser.RepositorySizeAPI.class)
            .get(GitHubRepoSizeEstimator.RepositorySizeGithubAPI.class);
