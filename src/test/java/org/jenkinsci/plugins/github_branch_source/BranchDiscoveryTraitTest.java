...
public class BranchDiscoveryTraitTest {
  ...
  public void given__discoverAll__when__appliedToContext__then__noFilter() throws Exception {
    ...
    assumeThat(
        ctx.authorities(),
        not(hasItem(instanceOf(BranchDiscoveryTrait.BranchSCMHeadAuthority.class))));
    ...
    assertThat(
        ctx.authorities(), hasItem(instanceOf(BranchDiscoveryTrait.BranchSCMHeadAuthority.class)));
  }
  ...
  public void given__onlyPRs__when__appliedToContext__then__filter() throws Exception {
    ...
    assertThat(
        ctx.filters(),
        contains(instanceOf(BranchDiscoveryTrait.OnlyOriginPRBranchesSCMHeadFilter.class)));
    assertThat(
        ctx.authorities(), hasItem(instanceOf(BranchDiscoveryTrait.BranchSCMHeadAuthority.class)));
  }
