...
public class GitHubSCMBuilderTest {
  ...
  public void createGitHubSCMSourceForTest(boolean configuredByUrl, String repoUrlToConfigure)
      throws Exception {
    if (configuredByUrl) {
  ...
  public void setUp() throws IOException {
    ...
    Credentials sshPrivateKeyCredential =
  ...
  public void given__cloud_branch_rev_anon__when__build__then__scmBuilt() throws Exception {
    ...
    assertThat(
        instance.refSpecs(),
        contains("+refs/heads/test-branch:refs/remotes/@{remote}/test-branch"));
    assertThat(
    ...
    assertThat(
        origin.getFetchRefSpecs().get(0).getDestination(), is("refs/remotes/origin/test-branch"));
    ...
    assertThat(
        revisions.iterator().next().getSha1String(),
        is("cafebabedeadbeefcafebabedeadbeefcafebabe"));
  }
  ...
  @Test
  public void given__cloud_branch_rev_anon_sshtrait_anon__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(false, null);
    BranchSCMHead head = new BranchSCMHead("test-branch");
    SCMRevisionImpl revision =
  ...
  @Test
  public void given__cloud_branch_rev_userpass_sshtrait_anon__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(false, null);
    BranchSCMHead head = new BranchSCMHead("test-branch");
    SCMRevisionImpl revision =
  ...
  @Test
  public void given__cloud_branch_rev_userkey_sshtrait_anon__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(false, null);
    BranchSCMHead head = new BranchSCMHead("test-branch");
    SCMRevisionImpl revision =
  ...
  @Test
  public void given__cloud_branch_rev_anon_sshtrait_userkey__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(false, null);
    BranchSCMHead head = new BranchSCMHead("test-branch");
    SCMRevisionImpl revision =
  ...
  @Test
  public void given__cloud_branch_rev_userpass_sshtrait_userkey__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(false, null);
    BranchSCMHead head = new BranchSCMHead("test-branch");
    SCMRevisionImpl revision =
  ...
  @Test
  public void given__cloud_branch_rev_userkey_sshtrait_userkey__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(false, null);
    BranchSCMHead head = new BranchSCMHead("test-branch");
    SCMRevisionImpl revision =
  ...
  public void given__server_branch_rev_anon__when__build__then__scmBuilt() throws Exception {
    ...
    assertThat(
        actual.getExtensions(),
        containsInAnyOrder(
            instanceOf(GitSCMSourceDefaults.class), instanceOf(BuildChooserSetting.class)));
    BuildChooserSetting chooser = getExtension(actual, BuildChooserSetting.class);
    assertThat(
        chooser.getBuildChooser(),
  ...
  @Test
  public void given__server_pullHead_norev_userpass__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(true, "https://github.test/tester/test-repo.git");
    PullRequestSCMHead head =
        new PullRequestSCMHead(
  ...
  public void given__cloud_pullMerge_rev_anon__when__build__then__scmBuilt() throws Exception {
    ...
    assertThat(
        origin.getFetchRefSpecs().get(1).getDestination(), is("refs/remotes/origin/test-branch"));
  ...
  public void given__cloud_pullMerge_norev_anon__when__build__then__scmBuilt() throws Exception {
    ...
    assertThat(
        actual.getExtensions(),
        containsInAnyOrder(
            instanceOf(GitSCMSourceDefaults.class), instanceOf(MergeWithGitSCMExtension.class)));
    MergeWithGitSCMExtension merge = getExtension(actual, MergeWithGitSCMExtension.class);
    assertThat(merge.getBaseName(), is("remotes/origin/test-branch"));
  ...
  @Test
  public void given__cloud_pullMerge_norev_userpass__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(false, null);
    PullRequestSCMHead head =
        new PullRequestSCMHead(
  ...
  public void given__server_pullMerge_norev_anon__when__build__then__scmBuilt() throws Exception {
    ...
    assertThat(
        actual.getExtensions(),
        containsInAnyOrder(
            instanceOf(MergeWithGitSCMExtension.class), instanceOf(GitSCMSourceDefaults.class)));
    MergeWithGitSCMExtension merge = getExtension(actual, MergeWithGitSCMExtension.class);
    assertThat(merge, notNullValue());
    assertThat(merge.getBaseName(), is("remotes/origin/test-branch"));
    assertThat(merge.getBaseHash(), is(nullValue()));
  ...
  @Test
  public void given__server_pullMerge_norev_userpass__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(true, "https://github.test/tester/test-repo.git");
    PullRequestSCMHead head =
        new PullRequestSCMHead(
  ...
  @Test
  public void given__server_pullMerge_norev_userkey__when__build__then__scmBuilt()
      throws Exception {
    createGitHubSCMSourceForTest(true, "https://github.test/tester/test-repo.git");
    PullRequestSCMHead head =
        new PullRequestSCMHead(
