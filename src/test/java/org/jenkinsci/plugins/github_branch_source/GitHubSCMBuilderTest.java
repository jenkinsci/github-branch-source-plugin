...
class GitHubSCMBuilderTest {
    ...
    private void createGitHubSCMSourceForTest(String repoUrlToConfigure) {
        if (configuredByUrl && repoUrlToConfigure != null) {
    ...
    void given__cloud_branch_rev_anon__when__build__then__scmBuilt() throws Exception {
        createGitHubSCMSourceForTest(null);
    ...
    @Test
    void given__cloud_branch_rev_anon_sshtrait_anon__when__build__then__scmBuilt() throws Exception {
        createGitHubSCMSourceForTest(null);
        BranchSCMHead head = new BranchSCMHead("test-branch");
        SCMRevisionImpl revision = new SCMRevisionImpl(head, "cafebabedeadbeefcafebabedeadbeefcafebabe");
        source.setCredentialsId(null);
    ...
    @Test
    void given__cloud_branch_rev_userpass_sshtrait_anon__when__build__then__scmBuilt() throws Exception {
        createGitHubSCMSourceForTest(null);
        BranchSCMHead head = new BranchSCMHead("test-branch");
        SCMRevisionImpl revision = new SCMRevisionImpl(head, "cafebabedeadbeefcafebabedeadbeefcafebabe");
        source.setCredentialsId("user-pass");
    ...
    @Test
    void given__cloud_branch_rev_userkey_sshtrait_anon__when__build__then__scmBuilt() throws Exception {
        createGitHubSCMSourceForTest(null);
        BranchSCMHead head = new BranchSCMHead("test-branch");
        SCMRevisionImpl revision = new SCMRevisionImpl(head, "cafebabedeadbeefcafebabedeadbeefcafebabe");
        GitHubSCMBuilder instance = new GitHubSCMBuilder(source, head, revision)
    ...
    @Test
    void given__cloud_branch_rev_anon_sshtrait_userkey__when__build__then__scmBuilt() throws Exception {
        createGitHubSCMSourceForTest(null);
        BranchSCMHead head = new BranchSCMHead("test-branch");
        SCMRevisionImpl revision = new SCMRevisionImpl(head, "cafebabedeadbeefcafebabedeadbeefcafebabe");
        source.setCredentialsId(null);
    ...
    @Test
    void given__cloud_branch_rev_userpass_sshtrait_userkey__when__build__then__scmBuilt() throws Exception {
        createGitHubSCMSourceForTest(null);
        BranchSCMHead head = new BranchSCMHead("test-branch");
        SCMRevisionImpl revision = new SCMRevisionImpl(head, "cafebabedeadbeefcafebabedeadbeefcafebabe");
        source.setCredentialsId("user-pass");
    ...
    @Test
    void given__cloud_branch_rev_userkey_sshtrait_userkey__when__build__then__scmBuilt() throws Exception {
        createGitHubSCMSourceForTest(null);
        BranchSCMHead head = new BranchSCMHead("test-branch");
        SCMRevisionImpl revision = new SCMRevisionImpl(head, "cafebabedeadbeefcafebabedeadbeefcafebabe");
        GitHubSCMBuilder instance = new GitHubSCMBuilder(source, head, revision)
    ...
    void given__server_branch_rev_anon__when__build__then__scmBuilt() throws Exception {
        createGitHubSCMSourceForTest("https://github.test/tester/test-repo.git");
        BranchSCMHead head = new BranchSCMHead("test-branch");
        ...
        assertThat(
                "expecting guess value until withGitHubRemote called",
                instance.remote(),
                is("https://" + (configuredByUrl ? "github.test" : "github.com") + "/tester/test-repo.git"));
        assertThat(instance.browser(), instanceOf(GithubWeb.class));
        assertThat(
                instance.browser().getRepoUrl(),
                is("https://" + (configuredByUrl ? "github.test" : "github.com") + "/tester/test-repo"));
    ...
    void given__server_branch_rev_userkey__when__build__then__scmBuilt() throws Exception {
        ...
        assertThat(
                instance.remote(),
                is("git@" + (configuredByUrl ? "github.test" : "github.com") + ":tester/test-repo.git"));
    ...
    void given__server_pullHead_rev_anon__when__build__then__scmBuilt() throws Exception {
        ...
        assertThat(
                instance.browser().getRepoUrl(),
                is("https://" + (configuredByUrl ? "github.test" : "github.com") + "/qa/qa-repo"));
