...
public class GithubSCMSourceTagsTest extends GitSCMSourceBase {
  ...
  public void testExistentSingleTag() throws IOException {
    ...
    Mockito.when(mockSCMHeadObserver.getIncludes())
        .thenReturn(
            Collections.singleton(
                new GitHubTagSCMHead("existent-tag", System.currentTimeMillis())));
    GitHubSCMSourceContext context = new GitHubSCMSourceContext(null, mockSCMHeadObserver);
    context.wantTags(true);
    GitHubSCMSourceRequest request =
        context.newRequest(new GitHubSCMSource("cloudbeers", "yolo", null, false), null);
  ...
  @Test
  public void testExistingMultipleTagsIteratorGHFileNotFoundExceptionOnHasNext()
      throws IOException {
  ...
  @Test
  public void testExistingMultipleTagsIteratorGHExceptionOnHasNextAndHasAtLeastOne()
      throws IOException {
  ...
  @Test
  public void testExistingMultipleTagsIteratorGHExceptionOnHasNextAndDoesNotHaveOne()
      throws IOException {
  ...
  @Test
  public void testExistingMultipleTagsIteratorGHExceptionOnHasNextButThrowsIOErrorOnGetRefs()
      throws IOException {
